...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_TitleScreen_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_TitleScreen_t qt_meta_stringdata_TitleScreen = {
    {
        QT_MOC_LITERAL(0, 11),  // "TitleScreen"
        QT_MOC_LITERAL(12, 13),  // "buttonClicked"
        QT_MOC_LITERAL(26, 0),  // ""
        QT_MOC_LITERAL(27, 11)   // "switchMenus"
    },
    "TitleScreen",
    "buttonClicked",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_TitleScreen[] = {
...
Q_CONSTINIT const QMetaObject TitleScreen::staticMetaObject = { {
    ...
    qt_meta_stringdata_TitleScreen.offsetsAndSizes,
...
void TitleScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &TitleScreen::buttonClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TitleScreen::buttonClicked()
{
